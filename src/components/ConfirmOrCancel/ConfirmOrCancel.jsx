...
import { handleSpeakerToken, handleTalkId, changeTalkStatus } from './ConfirmOrCancelActions';
    ...
    return (
      <div>
        ...
        <div id="confirmation">
          <h1>Confirmation</h1>
          <p>
            Thank you for visiting our Confirmation page. You have an upcoming
            event scheduled in three days. Please confirm your Talk. Or for what
            ever reason you are no longer available to speak at your event,
