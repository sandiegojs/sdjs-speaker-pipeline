...
class Talks extends Component {
  ...
  updateTalkInfo(e) {
    ...
    dispatch(
      updateTalkInfo(
        e.target.name,
        selectedTalk.talkChanges.topic,
        selectedTalk.talkChanges.description,
        selectedTalk.talkChanges.adminNotes,
        selectedTalk.toggleTalkEdit,
        accessToken,
      ),
    );
  }
                        ...
                        return (
                          <TableRow
                            ...
                            data={{
                              ...
                              eventDate: moment(talk.eventDate)
                                .add(1, 'day')
                                .format('YYYY-MM-DD'),
                            }}
                          />
